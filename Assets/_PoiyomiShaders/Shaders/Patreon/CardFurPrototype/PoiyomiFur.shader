Shader ".poiyomi/Protype/Fur"
{
    Properties
    {
        [HideInInspector] shader_is_using_thry_editor ("", Float) = 0
        [HideInInspector] shader_master_label ("<color=#ff0000ff>❤</color> <color=#000000ff>Poiyomi Toon Shader V5.3</color> <color=#ff0000ff>❤</color>", Float) = 0
        ...
        */
        [HideInInspector] m_fur ("Fur", Float) = 0
        _FurCardTexture ("Fur Card Texture", 2D) = "white" { }
        _FurCardAlphaTexture ("Fur Alpha Texture", 2D) = "white" { }
        _FurPattern ("Fur Pattern", 2D) = "white" { }
        [Normal]_FurCombMap ("Comb Map", 2D) = "bump" { }
        _FurClip ("Fur Clip", Range(0, 1)) = .1
        _FurRaised ("Fur Raised", Range(0, 1)) = .5
        _FurWidth ("Fur Width", Float) = 5
        _FurCardLength ("Fur Card Length", Float) = 10
        _FurAoStrength ("AO Strength", Range(0,1)) = .5
        ...
        [HideInInspector] m_optimization ("Optimization", Float) = 0
        [HideInInspector] m_start_distanceDithering ("Distance Dither", Float) = 0
        [Toggle(_)]_DitheringDistanceEnabled ("Distance Dithering", Float) = 1
        _DitheringOpaqueRange ("Dither Opaque Range", Float) = 20
        _DitheringInvisibleRange ("Dither Invisible Range", Float) = 30
        _DitheringDistanceMinAlpha ("Dither Min Dissolve", Range(0, 1)) = 0
        _DitheringDistanceMaxAlpha ("Dither Max Dissolve", Range(0, 1)) = 0.501
    ...
    /*
        ...
        */
        Pass
        {
            ...
            #pragma fragment FurFag
            #include "../../../Includes/CGI_PoiFurCardPass.cginc"
            ENDCG
