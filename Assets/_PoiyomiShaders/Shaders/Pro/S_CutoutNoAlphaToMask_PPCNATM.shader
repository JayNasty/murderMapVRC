Shader ".poiyomi/Pro/Cutout No Alpha To Mask"
{
    Properties
    {
        [HideInInspector] shader_is_using_thry_editor ("", Float) = 0
        [HideInInspector] shader_master_label ("<color=#ff0000ff>❤</color> <color=#000000ff>Poiyomi Pro V5.6</color> <color=#ff0000ff>❤</color>", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define CUTOUT
            #define CUTOUT_NO_ALPHA_TO_MASK
            // UV Distortion
