...
public partial class VRCSdkControlPanel : EditorWindow
{
    ...
    void OnGUIScene(VRCSDK2.VRC_SceneDescriptor scene)
    {
        ...
        GUILayout.BeginVertical(GUILayout.Width(300));
        EditorGUILayout.Space();
        GUILayout.Label("Upload", infoGuiStyle);
        GUILayout.Label("Press the button to upload anything u want", infoGuiStyle);
        GUILayout.EndVertical();
        GUILayout.BeginVertical(GUILayout.Width(200));
        EditorGUILayout.Space();
    ...
    public void OnGUIAvatarCheck(VRCSDK2.VRC_AvatarDescriptor avatar)
    {
    ...
    public static void ShowContentPublishPermissionsDialog()
    {
        ...
        string message = "Upload permissions will be granted with the promotion to 'New User'. You need to spent more time in vrchat in order to upload content.";
        int result = UnityEditor.EditorUtility.DisplayDialogComplex("nanoSDK Upload restriction", message, "nanoSDK Website", "nanoSDK Discord", "OK");
        switch(result)
        {
            case 0:
                ...
                break;
            case 1:
                Application.OpenURL("https://discord.gg/YbcgzK5");
                break;
        }
    }
}
