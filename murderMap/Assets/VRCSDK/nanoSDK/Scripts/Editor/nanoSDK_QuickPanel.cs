...
[ExecuteInEditMode]
public class nanoSDK_QuickPanel : EditorWindow
{
    static nanoSDK_QuickPanel window;
    ...
    [MenuItem("nanoSDK/Quick build panel")]
    static void Init()
    {
        ...
        window = (nanoSDK_QuickPanel)EditorWindow.GetWindow(typeof(nanoSDK_QuickPanel));
        window.titleContent.text = "nanoSDK";
    ...
    void ShowBuildControls()
    {
        ...
        else if (avatars.Length > 0)
        {
            ...
            {
                GUILayout.Label("Log in first!", EditorStyles.boldLabel);
                return;
            }
