Shader "#Milku/ToonV2" {
	Properties {
		...
		_LightDesaturate ("LightDesaturate", Float) = 0
		_highlightint ("highlightint", Float) = 1
		_FuncEffect ("FuncStrength", Range(0, 1)) = 0
		_Metal ("Cubemap Strength", Float) = 0
	}
	SubShader {
		Tags { "QUEUE" = "Overlay+2147479647" "RenderType" = "Opaque" }
		Pass {
			Name "OUTLINE"
			Tags { "QUEUE" = "Overlay+2147479647" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
			Cull Front
			GpuProgramID 62879
			Program "vp" {
				SubProgram "d3d11 " {
		...
		Pass {
			Name "FORWARD"
			Tags { "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Overlay+2147479647" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
			Stencil {
				Ref 128
			}
			GpuProgramID 92723
		...
		Pass {
			Name "FORWARD_DELTA"
			Tags { "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Overlay+2147479647" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
